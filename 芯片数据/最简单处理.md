...
#### 修改下面的分组信息
colnames(dat)=c("geneID","KO_ipsilateralhemisphere_#1","KO_contralateralhemisphere_#1","WT_ipsilateralhemisphere_#1","WT_contralateralhemisphere_#1","WT_ipsilateralhemisphere_#2","WT_contralateralhemisphere_#2","KO_ipsilateralhemisphere_#2","KO_contralateralhemisphere_#2","KO_ipsilateralhemisphere_#3","KO_contralateralhemisphere_#3","WT_ipsilateralhemisphere_#3","WT_contralateralhemisphere_#3")
